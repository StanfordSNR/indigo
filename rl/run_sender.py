...
class Learner(object):
    def __init__(self, state_dim, action_cnt, restore_vars):
        with tf.variable_scope('global'):
            self.model = RLLSTM(state_dim=state_dim, action_cnt=action_cnt)
        ...
        saver = tf.train.Saver(self.model.dagger_trainable_vars)
        ...
        uninit_vars -= set(self.model.dagger_trainable_vars)
